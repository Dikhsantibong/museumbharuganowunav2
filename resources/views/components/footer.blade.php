<footer class="footer">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <address class="address">
                    ...
                    <i class="fas fa-info-circle"></i> +44 (0)20
                    7942 2000
                </address>
            </div>
            <!-- end col-4 -->
    ...
    <div class="footer-bottom">
        <div class="container">
            <span class="copyright">© 2023 Wandau | Art & History Museum</span>
            <span class="creation">Site created by
                <a href="#">themezinho</a></span>
        </div>
        <!-- end container -->
    </div>
    <!-- end footer-bottom -->
