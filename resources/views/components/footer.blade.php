                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md">
                            ...
                            <ul class="list-unstyled list-separated gap-2">
                                ...
                                <li>
                                    <a href="https://status.tabler.io" class="link-muted" target="_blank"
                        ...
                        <div class="col-md">
                            ...
                            <ul class="list-unstyled list-separated gap-2">
                                ...
                                <li>
                                    <a href="https://github.com/tabler/tabler" class="link-muted" target="_blank"
            ...
            <div class="row g-4">
                <div class="col-lg-auto text-lg-end order-lg-last">
                    <div class="row justify-center">
                        <div class="col-auto">
                            ©<a href="https://codecalm.net" class="link-muted" target="_blank"
                                rel="noopener noreferrer">codecalm.net</a>
                        </div>
                        <div class="col-auto">
                            <ul class="list-inline list-inline-dots">
                                ...
                                <li class="list-inline-item">
                                    <a class="link-muted" href="/privacy-policy">Privacy policy</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        stroke-linejoin="round" class="icon text-red icon-inline icon-4">
