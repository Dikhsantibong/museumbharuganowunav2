...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-6 col-md-3 p-0">
                    <a href="#" class="card card-link card-link-pop bg-transparent rounded-0 py-3" target="_blank">
                        <div class="card-body">
                ...
                <div class="col-6 col-md-3 p-0">
                    <a href="/virtual-tour" class="card card-link card-link-pop bg-transparent rounded-0 py-3">
                        <div class="card-body">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="icon icon-md">
                ...
                <div class="col-6 col-md-3 p-0">
                    <a href="https://www.roblox.com/games/104634170739997/" target="_blank"
                        class="card card-link card-link-pop bg-transparent rounded-0 py-3">
                        <div class="card-body">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="icon icon-md">
    ...
    <section class="section py-5 section-light border-top">
        ...
        <div class="container mt-4">
            <div class="section-header text-start mx-0 mb-4">
                <h2 class="section-title">Koleksi Terbaru Museum</h2>
            </div>
            <div class="row row-cards">
                        ...
                        <a href="/koleksi/{{ $data->id_koleksi }}" class="card card-link mx-0 mb-3">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute bottom-0 start-0 w-100 px-3 rounded-bottom-3"
                                    ...
                                    <span class="text-white fs-2 d-block">
                                        {{ $data->nama_koleksi }}
                                    </span>
                                </div>
                            </div>
